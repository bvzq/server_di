...
def cv_multi(X,y,params,cv_splits,dims=None,isNN=True): # loss = tf.keras.losses.BinaryCrossentropy()
    #***CNN****
    if isNN:
        print("isNN")
        kf = KFold(n_splits=cv_splits,shuffle=True,random_state=0)
...
#print("multi job")
#n_splits = 4
#histories = cv_multi(X_train_multi,y_train_multi,params_multi,n_splits,dims) # , tf.keras.losses.CategoricalCrossentropy()
